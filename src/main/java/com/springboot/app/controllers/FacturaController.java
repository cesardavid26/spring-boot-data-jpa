...
public class FacturaController {
	...
	public String ver(@PathVariable(value="id") Long id,
		...
		Factura factura = clienteService.fetchFacturaByIdWithClienteWhitItemFacturaWithProducto(id);
	...
	public @ResponseBody List<Producto> cargarPorductos(@PathVariable String term){
	...
	public String guardar(@Valid Factura factura,
		...
		if(itemId==null || itemId.length==0) {
			model.addAttribute("titulo", "Crear factura");
			model.addAttribute("error", "Error: La factura NO puede estar sin lineas");
			return "factura/form";
		}
